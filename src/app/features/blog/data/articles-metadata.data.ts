...
export const BLOG_ARTICLES_METADATA: ArticleMetadata[] = [
  {
    ...
    description:
      'Tailscale stuck on "Starting…" on Windows 10? This guide walks through the complete fix for Docker Desktop, Hyper-V, and WSL2 systems where the Wintun driver fails to initialize due to corrupted network stack bindings.',
    author: AUTHORS.joel_hansen,
    publishedDate: '02-15-2026',
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Tailscale%20stuck%20on%20starting.../tailscale-windows-fix.jpg?updatedAt=1771178037021',
      alt: 'Fixing Tailscale Stuck on Starting on Windows 10 with Docker Desktop and Hyper-V',
    },
    tags: [
      'Tailscale',
      'Windows 10',
    ...
    category: 'Technology',
    metaDescription:
      'Fix Tailscale stuck on "Starting…" on Windows 10. Complete guide for Docker Desktop, Hyper-V, and WSL2 systems. Learn how to reset the Windows network stack and reinstall the Wintun driver properly.',
    metaKeywords: [
      'tailscale',
      'tailscale windows',
      'tailscale stuck starting',
      'tailscale not working',
      'tailscale windows 10',
      'tailscale docker',
      'tailscale hyper-v',
      'tailscale wsl2',
      'wintun driver',
      ...
      'tailscale vpn',
      'tailscale windows fix',
      'tailscale installation issues',
      'tailscale service running but not connecting',
  ...
  },
  {
    ...
    description:
      'TCL Roku TVs are failing with the "black screen of death" just after warranty expires. A class action investigation is underway over the defect and Roku\'s controversial Terms of Service updates that block lawsuits.',
    author: AUTHORS.joel_hansen,
    publishedDate: '02-03-2026',
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Roku%20Class%20Action%20Lawasuit/og-roku-tv-black-screen-class-action.jpg?updatedAt=1770159135857',
      alt: 'Roku TV Black Screen of Death: Class Action Investigation Into TCL Roku TV Defects',
    },
    tags: [
      'Roku',
      'Roku TV',
    ...
    category: 'Technology',
    metaDescription:
      'TCL Roku TVs are failing with black screen defects 18-24 months after purchase. Learn about the class action investigation, Roku\'s controversial Terms of Service, and what you can do if your Roku TV has the black screen of death.',
    metaKeywords: [
      'roku',
      'tv roku',
      'roku tv',
      ...
      'roku black screen of death',
      'tcl roku tv defect',
      'roku tv not working',
      'roku class action lawsuit',
      'roku tv class action',
      'tcl tv problems',
      'roku tv black screen with sound',
      'roku tv warranty',
      'roku terms of service',
      'roku arbitration clause',
      'defective roku tv',
      'roku tv repair',
      'tcl roku tv recall',
    ],
  ...
  },
  {
    ...
    metaKeywords: [
      ...
      'taco food truck near me',
      'mexican food truck near me',
      'Pensacola food trucks',
      'Pensacola mexican food',
      'Taco Trolley Pensacola',
      'Tacos El Amigo',
      'Tacos La Mixteca',
      'Carne Asada Darling',
      'Frontera\'s Tacos',
      ...
      'Mex-N-Go',
      'Nicaraguan food Pensacola',
      'birria tacos Pensacola',
      'quesabirria',
      'street tacos Pensacola',
      'authentic tacos Pensacola',
      'Cantonment mexican food',
      'Downtown Pensacola tacos',
      'Gulf Breeze food truck',
    ],
    featured: true,
    hasAudio: false,
    hasVideo: false,
  ...
  description:
    'Your birthday is basically a loyalty checkpoint. Here’s a curated, practical guide to the best birthday freebies and discounts across food, retail, entertainment, and local city lists — plus how to claim them.',
  author: AUTHORS.joel_hansen,
  publishedDate: '01-25-2026',
  heroImage: {
    src: 'https://ik.imagekit.io/allthethingsdev/Birthday%20Freebies/og-image-borthday-freebies-list.jpg',
    alt: 'Birthday Freebies Guide: 100+ Deals for Food, Retail, and Entertainment',
  },
  tags: [
    'Freebies',
    'Deals',
...
},
  {
    ...
    publishedDate: '01-25-2026',
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Photo-filter-studio-tutorial/og-photo-filter-studio-2.jpg',
      alt: 'Photo Filter Studio Tutorial: Edit Photos Like a Pro',
    },
    ...
    metaKeywords: [
      ...
      'Privacy photo editing',
      'Client-side photo editing',
  ...
  },
  {
    ...
    publishedDate: '01-25-2026',
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Gradient%20Generator%20Tutorial/og-gradient-generator-tutorial.jpg',
      alt: 'Gradient Generator Tutorial: Create Beautiful CSS Gradients',
    },
  ...
  },
  {
    ...
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Social%20Media%20Launchpad/og-social-media-post-composer.jpg?updatedAt=1769182782362',
  ...
  },
  {
    ...
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Exploding%20trees%20in%20winter/og-exploding-trees-in-winter.jpg',
    ...
    metaKeywords: [
      ...
      'Frost cracking',
      'Trees cracking in cold',
      'Why do trees explode in winter',
      'Tree frost damage',
      'Winter tree sounds',
      'Frozen sap expansion',
      'Tree gunshot sounds',
      'Arctic blast tree damage',
      'Extreme cold weather',
      'Tree splitting winter',
      'Frost crack trees',
    ],
    featured: true,
    hasAudio: false,
    hasVideo: true,
    youtubeVideoId: 'Q258I2KVGzU',
    display: true,
  ...
  },
  {
    ...
    publishedDate: '01-22-2026',
    heroImage: {
      src: 'https://ik.imagekit.io/allthethingsdev/Masters%20of%20the%20universe%202026/og-masters-of-the-universe-he-man-returns.jpg',
      alt: 'Masters of the Universe 2026: He-Man Returns to the Big Screen',
    },
  ...
  },
  {
    ...
    description:
      "How the Taj Mahal House on Scenic Highway became Pensacola's most controversial golden-roofed landmark.",
    author: AUTHORS.joel_hansen,
    ...
    heroImage: {
      ...
      alt: 'The Taj Mahal House: The WILD Story of Pensacola\'s Gaudy Palace on Scenic Highway',
    },
    tags: ['Pensacola', 'Scenic Highway', 'Taj Mahal House', 'Palace', 'Architecture'],
    category: 'Amateur Sleuthing',
    metaDescription:
      "The wild story of the Taj Mahal House in Pensacola - how this golden-roofed mansion on Scenic Highway became Florida's most controversial landmark.",
    metaKeywords: [
      'Taj Mahal House',
      'Taj Mahal House Pensacola',
      'Pensacola Taj Mahal',
      'Scenic Highway palace',
      'Pensacola golden mansion',
      'Taj Mahal Pensacola Florida',
      'Scenic Highway Pensacola',
      'Gaudy palace Pensacola',
      'Pensacola landmarks',
      'Controversial mansion Pensacola',
      'Golden roof house Pensacola',
    ],
    featured: true,
