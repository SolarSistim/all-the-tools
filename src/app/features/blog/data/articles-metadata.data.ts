...
export const BLOG_ARTICLES_METADATA: ArticleMetadata[] = [
  {
    id: '111',
    slug: 'pensacola-food-trucks-complete-guide',
    title: 'The Complete Guide to Food Trucks in Pensacola, FL',
    description:
      'An authoritative guide to the best food trucks in Pensacola, from Taco Trolley\'s downtown icon to The Happy Taco\'s Cantonment gem and Carne Asada Darling\'s Nicaraguan excellence. Everything you need to know about finding mobile food trucks, food truck catering, and the local taco truck scene.',
    ...
    heroImage: {
      ...
      alt: 'The Complete Guide to Food Trucks in Pensacola, FL',
    },
    tags: [
      'Food Trucks',
      'Pensacola',
    ...
    metaDescription:
      'The definitive guide to Pensacola food trucks. Find the best taco trucks, Mexican food trucks, and Nicaraguan cuisine in Pensacola and Cantonment. Includes Taco Trolley, The Happy Taco, and Carne Asada Darling reviews, food truck catering info, and tips for finding food trucks near you.',
    metaKeywords: [
      'food near me',
      'truck food near me',
      'food truck menu',
      ...
      'Cantonment food',
      'Downtown Pensacola food',
      'East Pensacola food trucks',
    ],
    featured: true,
    hasAudio: false,
    hasVideo: false,
