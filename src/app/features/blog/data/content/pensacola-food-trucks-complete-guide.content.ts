...
export const content: ContentBlock[] = [
  ...
  },
  {
    type: 'paragraph',
    data: {
      text: 'You\'ve got all the overhead of a restaurant — ingredients, labor, licensing, insurance — but you\'re operating out of a vehicle the size of a walk-in closet. You can\'t seat customers. You can\'t take reservations. You\'re entirely dependent on foot traffic, weather, and whether the lot owner decides to kick you out tomorrow.',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'The food trucks that survive do three things exceptionally well:',
    },
  },
  {
    type: 'list',
    data: {
      style: 'ordered',
      items: [
        '<strong>They specialize.</strong> You can\'t be everything to everyone when you\'re working with 100 square feet of kitchen space. The best food trucks — whether it\'s a taco food truck, pizza food truck, or BBQ food truck — pick a lane and dominate it.',
        '<strong>They build community.</strong> Food truck rental costs are brutal, which is why smart operators become fixtures in specific neighborhoods or events. Regular customers become evangelists.',
        '<strong>They execute flawlessly.</strong> When you can\'t compete on ambiance or convenience, you compete on quality. Every dish has to be perfect because there\'s no second chance.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    data: {
      level: 2,
      text: 'Finding Food Trucks Near Me: The Reality vs. The Apps',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'Let\'s address the obvious question: why is finding "taco truck near me" or "mexican food truck near me" still such a pain in 2026?',
    },
  },
  {
    type: 'paragraph',
  ...
  },
  {
    type: 'paragraph',
    data: {
      text: 'Your best bet for finding food trucks near me in Pensacola:',
    },
  },
  {
    type: 'list',
    data: {
      style: 'unordered',
      items: [
        '<strong>Follow them on Facebook.</strong> Most local food trucks post their weekly schedules on social media. It\'s not elegant, but it works.',
        '<strong>Check brewery schedules.</strong> Many local breweries host rotating food trucks on weekends.',
        '<strong>Look for events.</strong> Food truck catering at festivals, farmers markets, and community events is where you\'ll find the most variety.',
        '<strong>Ask locals.</strong> Seriously. Pensacola\'s food truck community is small enough that word-of-mouth still matters.',
      ],
    },
  },
  {
    ...
    data: {
      level: 2,
      text: 'Food Truck Catering: What You Need to Know',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'Here\'s something most people don\'t realize: food truck catering has become absurdly popular for weddings, corporate events, and private parties. And for good reason — you get restaurant-quality food without the restaurant markup, plus the built-in novelty factor.',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'Several of these trucks handle catering, though their approaches differ based on location and setup. Taco Trolley\'s downtown location makes them accessible for corporate lunch events, while trucks like The Happy Taco and Frontera\'s Tacos work better for longer-format events where they can park and serve for several hours.',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'If you\'re considering food truck catering for an event:',
    },
  },
  {
    type: 'list',
    data: {
      style: 'unordered',
      items: [
        '<strong>Book early.</strong> Good food trucks get reserved weeks or months in advance, especially during wedding season.',
        '<strong>Confirm power and water access.</strong> Some trucks are fully self-sufficient. Others need hookups.',
        '<strong>Discuss menu customization.</strong> Most operators can adapt their food truck menu for dietary restrictions or preferences.',
        '<strong>Budget appropriately.</strong> Expect $15-25 per person for a full meal, more for premium proteins or extensive menus.',
        '<strong>Have a backup plan for weather.</strong> Mobile food trucks can\'t always operate in extreme conditions.',
      ],
    },
  },
  {
    ...
    data: {
      level: 2,
      text: 'The Verdict: Is Pensacola\'s Food Truck Scene Worth Exploring?',
    },
  },
  {
    type: 'paragraph',
    data: {
      text: 'Absolutely. But let\'s calibrate expectations.',
    },
  },
  {
    type: 'paragraph',
